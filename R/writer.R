...
wrSVfix <- function() {
  glue::glue('### Useful stuff \n',
             ...
             '  ggData1 = ggData[express == TRUE, .(nExpress = .N), by = c("group","sub")] \n',
             '  ggData2 = ggData[, "avgExp" := lapply(.SD, mean), .SDcols = c("val2"), by = c("group","sub")] \n',
             '  ggData = ggData[, .(nCells = .N), by = c("group","sub")] \n',
             '  #ggData = ggData[, .(avgExp = mean(val2)), by = "group"] \n',
             '  #ggData = ggData2[ggData1[ggData, on = "group"], on = "group"] \n',
             '  ggData = ggData1[ggData, on = c("group","sub")] \n',
             '  ggData = ggData2[ggData, on = c("group","sub")] \n',
             '  ggData = ggData[, c("group", "sub", "nCells", "nExpress", "avgExp"), with = FALSE] \n',
             '  ggData = unique(ggData) \n',
