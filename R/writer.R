...
wrSVfix <- function() {
  glue::glue('### Useful stuff \n',
             ...
             '  linkouts_url <- paste0("https://services.lis.ncgr.org/gene_linkouts?genes=", gene) \n',
             ...
             '    linkouts_html <- paste( \n',
             '      "<dl>", \n',
             '      paste(sprintf("<dt><a href=\'%s\' target=\'_blank\'>%s</a>", linkouts$href, linkouts$text), collapse = "\n"), \n',
             '      "</dl>", \n',
             '      sep = "\n" \n',
             '    ) \n',
             '  }} \n',
