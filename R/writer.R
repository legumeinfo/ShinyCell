...
wrSVfix <- function() {
  glue::glue('### Useful stuff \n',
             ...
             '}}  \n',
             ' \n',
             '# TODO: get linkouts from adf\'s web component \n',
             'toLinkout <- function(gene) sprintf("<a href=\'https://medicago.toulouse.inra.fr/MtrunA17r5.0-ANR/web/fatal/entry.html?accession=%s\' target=\'_blank\'>%s</a>", gene, gene) \n',
             ' \n',
             '# Plot theme \n',
             ...
             '  # Actual data.table \n',
             '  ggData$express = "none" \n',
             '  inp1_link <- toLinkout(inp1) \n',
             '  inp2_link <- toLinkout(inp2) \n',
             '  ggData[val1 > 0]$express <- inp1_link \n',
             '  ggData[val2 > 0]$express <- inp2_link \n',
             '  ggData[val1 > 0 & val2 > 0]$express = "both" \n',
             '  ggData$express <- factor(ggData$express, levels = unique(c("both", inp1_link, inp2_link, "none"))) \n',
...
wrSVmain <- function(prefix, subst = "") {
  glue::glue('optCrt="{{ option_create: function(data,escape) {{return(\'<div class=\\"create\\"><strong>\' + \'</strong></div>\');}} }}" \n', 
             ...
             '  }}) \n',
             '  output${prefix}a1lnk2 <- renderUI(HTML(toLinkout(input${prefix}a1inp2))) \n',
             '   \n',
             ...
             '  }}) \n',
             '  output${prefix}a3lnk1 <- renderUI(HTML(toLinkout(input${prefix}a3inp1))) \n',
             ...
             '             input${prefix}a3fsz, input${prefix}a3asp, input${prefix}a3txt) \n',
             '  }}) \n',
             '  output${prefix}a3lnk2 <- renderUI(HTML(toLinkout(input${prefix}a3inp2))) \n',
             ...
             '  }}) \n',
             '  output${prefix}b2lnk1 <- renderUI(HTML(toLinkout(input${prefix}b2inp1))) \n',
             ...
             '  }}) \n',
             '  output${prefix}b2lnk2 <- renderUI(HTML(toLinkout(input${prefix}b2inp2))) \n',
